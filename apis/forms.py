...
class SeoForm(forms.Form):
  seo_url = forms.CharField(label = 'INSIRA O URL/DOMÍNIO', max_length = 70, strip=True, required=True,  widget=forms.TextInput(attrs={'placeholder': 'www.exemplo.com.br ou exemplo.com.br'}))
